        ...
        <div class="card-body">
            <form method="POST" class="form-horizontal">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="nameId" class="form-control" value="<?= $product->name; ?>">
                            <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="price" id="priceId" class="form-control" value="<?= $product->price; ?>">
                            <?php
                ...
                <div style="text-align: center;">
                    <input type="submit" name="edit_product" class="btn btn-primary" value="Save">
                </div>
            </form>
        </div>
    </div>
