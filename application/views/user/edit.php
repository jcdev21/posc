                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <select name="level" id="levelId" class="form-control">
                                    ...
                                    <?php foreach ($levels as $level) { ?>
                                        <option value="<?= $level->id; ?>" <?= set_select('level', $level->id, $user->level_id === $level->id ? TRUE : FALSE); ?>><?= $level->level; ?></option>
                                    <?php } ?>
                                </select>
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="nameId" class="form-control" value="<?= $user->name; ?>">
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" id="contactId" class="form-control" value="<?= $user->contact; ?>">
                                <?php
                            ...
                            <div class="form-check">
                                <input type="checkbox" name="status" id="statusId" class="form-check-input" value="active" <?= ($user->status === 'active') ? 'checked' : '' ?>>
